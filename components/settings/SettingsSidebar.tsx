        ...
        <aside className="lg:col-span-3 mb-8 lg:mb-0">
            <nav className="space-y-1">
                ...
                <button
                    ...
                    className="w-full group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-red-600 hover:bg-red-50 dark:hover:bg-red-900/10 transition-all duration-200 mt-6"
                >
